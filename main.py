...
class Ui_Home(object):
    def setupUi(self, Home):
        ...
        Home.resize(500, 400)
        Home.setMinimumSize(QtCore.QSize(500, 400))
        Home.setMaximumSize(QtCore.QSize(500, 400))
        self.centralwidget = QtWidgets.QWidget(Home)
        self.centralwidget.setObjectName("centralwidget")
        self.gridLayout = QtWidgets.QGridLayout(self.centralwidget)
        self.gridLayout.setObjectName("gridLayout")
        self.upload_excel = QtWidgets.QPushButton(self.centralwidget)
        self.upload_excel.setMinimumSize(QtCore.QSize(0, 50))
        ...
        self.gridLayout.addWidget(self.upload_excel, 0, 0, 1, 1)
        self.print_or_download = QtWidgets.QPushButton(self.centralwidget)
        self.print_or_download.setMinimumSize(QtCore.QSize(0, 50))
        ...
        self.gridLayout.addWidget(self.print_or_download, 1, 0, 1, 1)
    ...
    def retranslateUi(self, Home):
        ...
        Home.setWindowTitle(_translate("Home", "Grean House LK"))
        self.upload_excel.setText(_translate("Home", "Upload Excel"))
        self.print_or_download.setText(_translate("Home", " Download"))
